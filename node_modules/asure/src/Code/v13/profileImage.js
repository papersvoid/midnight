...
async function profileImage(userParam){
    ...
    if(user.displayAvatarURL({dynamic: true})?.endsWith(".gif")){
        const nitro = await read(`${process.cwd()}/node_modules/asure/src/Images/profileImage/Badges/v13/NITRO.png`)
        const boost = await read(`${process.cwd()}/node_modules/asure/src/Images/profileImage/Badges/v13/BOOST.png`)
    ...
    if(!user.bot){
        ...
        for (let i = 0; i < flags.length; i++) {
            let badge = await read(`${process.cwd()}/node_modules/asure/src/Images/profileImage/Badges/v13/${flags[i]}.png`);
            badges.push(badge);
          }
