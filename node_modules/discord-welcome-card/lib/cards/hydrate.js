...
function drawCard(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (_b = (_0 = options.card).border) !== null && _b !== void 0 ? _b : (_0.border = true);
        (_c = (_1 = options.card).rounded) !== null && _c !== void 0 ? _c : (_1.rounded = true);
        (_d = (_2 = options.card).blur) !== null && _d !== void 0 ? _d : (_2.blur = true);
        (_e = options.avatar) !== null && _e !== void 0 ? _e : (options.avatar = {});
        (_f = (_3 = options.avatar).imageRadius) !== null && _f !== void 0 ? _f : (_3.imageRadius = 0.8);
        //Parsing the Theme
        ...
        if (avatar) {
            ...
            if (avatarImage) {
                ...
                ctx.drawImage(yield (0, core_1.toImage)(avatarImage), h / 2 - radius + ((_u = avatar.outlineWidth) !== null && _u !== void 0 ? _u : 0), //x
                h / 2 - radius + ((_v = avatar.outlineWidth) !== null && _v !== void 0 ? _v : 0), //y
                radius * 2 - ((_w = avatar.outlineWidth) !== null && _w !== void 0 ? _w : 0) * 2, //width
                radius * 2 - ((_x = avatar.outlineWidth) !== null && _x !== void 0 ? _x : 0) * 2 //height
                );
            }
        }
        timer.step('avatar');
        (0, lib_1.snap)(canvas);
        const buff = canvas.toBuffer((_z = (_y = options.generation) === null || _y === void 0 ? void 0 : _y.format) !== null && _z !== void 0 ? _z : 'image/png');
        timer.step('buffer');
        timer.stop();
        return buff;
    });
