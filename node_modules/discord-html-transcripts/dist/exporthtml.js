...
function generateTranscript(messages, channel, opts) {
    ...
    var _loop_1 = function (message) {
        ...
        authorName.style.color = (_j = (_h = message.member) === null || _h === void 0 ? void 0 : _h.displayHexColor) !== null && _j !== void 0 ? _j : "#ffffff";
        content.appendChild(authorName);
        if (author.bot) {
            var botTag = document.createElement('span');
            botTag.classList.add('chatlog__bot-tag');
            botTag.textContent = (((_k = author.flags) === null || _k === void 0 ? void 0 : _k.has("VERIFIED_BOT")) ? '✔ ' : '') + 'BOT';
        ...
        if (message.attachments && message.attachments.size > 0) {
            for (var _3 = 0, _4 = Array.from(message.attachments.values()); _3 < _4.length; _3++) {
                var attachment = _4[_3];
                var attachmentsDiv = document.createElement('div');
                attachmentsDiv.classList.add('chatlog__attachment');
                var attachmentType = ((_l = attachment.name) !== null && _l !== void 0 ? _l : "unknown.png").split('.').pop().toLowerCase();
                if (['png', 'jpg', 'jpeg', 'gif'].includes(attachmentType)) {
                    ...
                    attachmentImage.src = (_m = attachment.proxyURL) !== null && _m !== void 0 ? _m : attachment.url;
                    ...
                    attachmentVideo.src = (_o = attachment.proxyURL) !== null && _o !== void 0 ? _o : attachment.url;
                    ...
                    attachmentAudio.src = (_p = attachment.proxyURL) !== null && _p !== void 0 ? _p : attachment.url;
                    ...
                    attachmentGenericNameLink.href = (_q = attachment.proxyURL) !== null && _q !== void 0 ? _q : attachment.url;
        ...
        if (message.embeds && message.embeds.length > 0) {
            var _loop_2 = function (embed) {
                ...
                // embed author
                if ((_r = embed.author) === null || _r === void 0 ? void 0 : _r.name) {
                ...
                if (embed.fields && embed.fields.length > 0) {
                    ...
                    for (var _8 = 0, _9 = embed.fields; _8 < _9.length; _8++) {
                        var field = _9[_8];
                        var embedField = document.createElement('div');
                        (_7 = embedField.classList).add.apply(_7, (!field.inline ? ['chatlog__embed-field'] : ['chatlog__embed-field', 'chatlog__embed-field--inline']));
                        // Field name
                ...
                // embed thumbnail
                if ((_t = (_s = embed.thumbnail) === null || _s === void 0 ? void 0 : _s.proxyURL) !== null && _t !== void 0 ? _t : (_u = embed.thumbnail) === null || _u === void 0 ? void 0 : _u.url) {
                    ...
                    embedThumbnailLink.href = (_v = embed.thumbnail.proxyURL) !== null && _v !== void 0 ? _v : embed.thumbnail.url;
                    var embedThumbnailImage = document.createElement('img');
                    embedThumbnailImage.classList.add('chatlog__embed-thumbnail');
                    embedThumbnailImage.src = (_w = embed.thumbnail.proxyURL) !== null && _w !== void 0 ? _w : embed.thumbnail.url;
                ...
                if (embed.image) {
                    ...
                    embedImageLink.href = (_x = embed.image.proxyURL) !== null && _x !== void 0 ? _x : embed.image.url;
                    var embedImageImage = document.createElement('img');
                    embedImageImage.classList.add('chatlog__embed-image');
                    embedImageImage.src = (_y = embed.image.proxyURL) !== null && _y !== void 0 ? _y : embed.image.url;
                ...
                // footer
                if ((_z = embed.footer) === null || _z === void 0 ? void 0 : _z.text) {
                    ...
                    if (embed.footer.iconURL) {
                        ...
                        embedFooterIcon.src = (_0 = embed.footer.proxyIconURL) !== null && _0 !== void 0 ? _0 : embed.footer.iconURL;
            ...
            for (var _5 = 0, _6 = message.embeds; _5 < _6.length; _5++) {
                var embed = _6[_5];
                _loop_2(embed);
            }
        }
    ...
    // Messages
    for (var _i = 0, _2 = (Array.from(messages.values())).sort(function (a, b) { return a.createdTimestamp - b.createdTimestamp; }); _i < _2.length; _i++) {
        var message = _2[_i];
        _loop_1(message);
    }
    ...
    if (opts.returnType === "attachment")
        return new discord.MessageAttachment(Buffer.from(serialized), (_1 = opts.fileName) !== null && _1 !== void 0 ? _1 : 'transcript.html');
