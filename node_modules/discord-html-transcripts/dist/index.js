...
var generateFromMessages = function (messages, channel, opts) {
    ...
    if (('returnBuffer' in options))
        options.returnType = (_a = options.returnType) !== null && _a !== void 0 ? _a : (options.returnBuffer ? 'buffer' : 'attachment');
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                last_id = (_b = messages.last()) === null || _b === void 0 ? void 0 : _b.id;
                if (messages.size != 100 || ((options.limit > 0) && sum_messages.length >= options.limit))
                    return [3 /*break*/, 3];
                return [3 /*break*/, 1];
            case 3: return [2 /*return*/, (0, exporthtml_1.default)(sum_messages, channel, options)];
        }
    });
}); };
